...
class TaskProvider extends ChangeNotifier {
  ...
  List<Task> _dummyData = [
    Task(id:1,priority: 2,icon:3, title:"Test 1", isTaskDone: false,description: "testing task list views",date: DateTime.now()),
    Task(id:2,priority: 1,icon:5, title:"Test 2", isTaskDone: false,description: "testing task list views",date: DateTime.now()),
    Task(id:3,priority: 2,icon:1, title:"Test 3", isTaskDone: false,description: "testing task list views",date: DateTime.now()),
    Task(id:4,priority: 3,icon:9, title:"Test 4", isTaskDone: false,description: "testing task list views",date: DateTime.now()),
    Task(id:5,priority: 3,icon:7, title:"Test 5", isTaskDone: false,description: "testing task list views",date: DateTime.now())
  ];
  int selectedIndex = 0;
  DateTime focDay =
  ...
  Future<List<Task>> getTaskDbList() async {
    _dummyData.forEach((element) {
      addTaskMarker(element, element.date);
    });
    //_taskList = getCalendarValues(focDay);
    // List<Task> list = [];
