...
//
// //todo make it universal - fromMap method here:
// Future<List<SettingsModel>> restoreList(String key,
//     List<SettingsModel> list) async {
//   SharedPreferences prefs = await SharedPreferences.getInstance();
//   final result = prefs.getStringList(key);
//
//   try {
...
// }
//
// Future<List<PermissionModel>> restorePermissionsList(String key,
//     List<PermissionModel> list) async {
//   SharedPreferences prefs = await SharedPreferences.getInstance();
//   final result = prefs.getStringList(key);
//
//   try {
...
//
// //dynamic restore lists:
// Future<List<T>> restoreObjectList<T>(String key,
//     List<T> list,
//     T Function(Map<String, dynamic>) fromMapFunction) async {
//   SharedPreferences prefs = await SharedPreferences.getInstance();
//   final result = prefs.getStringList(key);
//
//   try {
...
//
//
// Future<List<TrashModel>> restoreTrashList(String key,
//     List<TrashModel> list) async {
//   SharedPreferences prefs = await SharedPreferences.getInstance();
//   final result = prefs.getStringList(key);
//
//   try {
