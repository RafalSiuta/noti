...
class _TaskCreatorState extends State<TaskCreator>
    ...
    if (picked != null && picked != widget.newTask.date) {
      setState(() {
        TimeOfDay time = TimeOfDay(
          hour: widget.newTask.date.hour,
          minute: widget.newTask.date.minute,
        );
  ...
  void initState() {
    ...
    titleVal.text = widget.newTask.title.isNotEmpty
        ? widget.newTask.title[0].toUpperCase() +
              widget.newTask.title.substring(1)
        : '';
    titleVal.selection = TextSelection.fromPosition(
      const TextPosition(offset: 0),
    );
    descVal.text = widget.newTask.description.isNotEmpty
        ? widget.newTask.description[0].toUpperCase() +
              widget.newTask.description.substring(1)
        : '';
  ...
  Widget build(BuildContext context) {
    var isTaskDoneColor = widget.newTask.isTaskDone
                                ...
                                children: [
                                  Rater(
                                    ...
                                    onRatingChanged: (rating) => setState(() {
                                      ...
                                      widget.newTask.priority = rating.toInt();
                                    }),
                                  ),
                                  Column(
                                    mainAxisSize: MainAxisSize.min,
