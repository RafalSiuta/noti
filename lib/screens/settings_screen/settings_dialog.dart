...
class SliderDialog extends StatelessWidget {
  const SliderDialog({super.key, required this.index});
  final int index;
          ...
          child: Column(
            ...
            children: [
              ...
              RichText(
                ...
                text: TextSpan(
                  text: context
                      .t("settings_text.settings_dial_info")
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      text:
                          " ${sliderVal.toStringAsFixed(0)} ${context.t("settings_text.settings_dial_month").capitalizeFirstLetter()}\n\n",
                    ),
                    TextSpan(
                      text: context
                          .t("settings_text.settings_dial_confirm")
                          .capitalizeFirstLetter(),
                      // text: "Are You sure?",
              ...
              Row(
                ...
                children: [
                  ...
                  DialogButton(
                    isConfirmed: true,
                    popOnConfirm: false,
                    onConfirm: () => Navigator.of(context).pop(sliderVal > 0),
                  ),
                ],
              ),
            ],
