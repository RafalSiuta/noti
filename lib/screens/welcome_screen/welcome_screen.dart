...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tradingSundayTitle = context.select<HolidaysProvider, String?>(
      (provider) =>
          DateHeader.tradingSundayTitleFor(context, selectedDate, provider),
    );
          ...
          child: ClipRRect(
            ...
            child: BackdropFilter(
              filter: ImageFilter.blur(
                sigmaX: intensiveBlurValue,
                sigmaY: intensiveBlurValue,
              ),
              child: Container(
