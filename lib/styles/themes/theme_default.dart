...
final themeDefault = ThemeData(
    ...
    style: ButtonStyle(
      ...
      side: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.pressed) ||
          ...
          return const BorderSide(color: themeDefIndicatorColor,);
        }
        return const BorderSide(color: themeDefBaseTextColor);
      }),
      splashFactory: NoSplash.splashFactory,
  ...
  datePickerTheme: DatePickerThemeData(
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        themeDefIndicatorColor.withValues(alpha: 0.5),
      ),
  ...
  timePickerTheme: TimePickerThemeData(
    ...
    hourMinuteColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return themeDefIndicatorColor.withOpacity(
          0.5,
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        themeDefIndicatorColor.withOpacity(0.5),
      ),
      foregroundColor: WidgetStateProperty.all(themeDefBaseTextColor),
      textStyle: WidgetStateProperty.all(
        GoogleFonts.exo2(
  ...
  tooltipTheme: TooltipThemeData(
    ...
    decoration: BoxDecoration(color: themeDefUnselectedColor),
  ),
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    enabledBorder: UnderlineInputBorder(
      borderSide: BorderSide(width: .5, color: themeDefUnselectedColor),
    ),
    ...
    suffixStyle: TextStyle(color: themeDefTitleBoxBcgColor),
    ...
    helperMaxLines: 1,
    helperStyle: TextStyle(color: themeDefUnselectedColor, fontSize: 8.0),
    labelStyle: TextStyle(color: themeDefUnselectedColor, fontSize: 20),
    alignLabelWithHint: true,
    prefixStyle: TextStyle(color: themeDefUnselectedColor),
  ),
