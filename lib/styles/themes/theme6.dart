...
const theme8SelDayColor = Color(0xFF5B3E28);
...
final theme8 = ThemeData(
    ...
    style: ButtonStyle(
      ...
      side: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.pressed) ||
          ...
          return const BorderSide(color: theme8IndicatorColor);
        }
        return const BorderSide(color: theme8BaseTextColor);
      }),
      splashFactory: NoSplash.splashFactory,
  ...
  datePickerTheme: DatePickerThemeData(
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        theme8IndicatorColor.withOpacity(0.5),
      ),
  ...
  timePickerTheme: TimePickerThemeData(
    ...
    hourMinuteColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return theme8IndicatorColor.withValues(
          alpha: 0.5,
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        theme8IndicatorColor.withValues(alpha: 0.5),
      ),
      foregroundColor: WidgetStateProperty.all(theme8BaseTextColor),
      textStyle: WidgetStateProperty.all(
        GoogleFonts.poppins(
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    enabledBorder: UnderlineInputBorder(
      borderSide: BorderSide(width: .5, color: theme8UnselectedColor),
    ),
    ...
    isDense: true,
    filled: false,
    hintStyle: TextStyle(color: theme8UnselectedColor, fontSize: 20),
    contentPadding: EdgeInsets.symmetric(vertical: 5.0, horizontal: 0.0),
    suffixStyle: TextStyle(color: theme8TitleBoxBcgColor),
    helperMaxLines: 1,
    ...
    labelStyle: TextStyle(color: theme8UnselectedColor, fontSize: 20),
    alignLabelWithHint: true,
    prefixStyle: TextStyle(color: theme8UnselectedColor),
  ),
