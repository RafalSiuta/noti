...
const theme6SelDayColor = Color(0xFF65718D);
...
final theme6 = ThemeData(
    ...
    style: ButtonStyle(
      ...
      side: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.pressed) ||
          ...
          return const BorderSide(color: theme6IndicatorColor);
        }
        return const BorderSide(color: theme6BaseTextColor);
      }),
      splashFactory: NoSplash.splashFactory,
  ...
  datePickerTheme: DatePickerThemeData(
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        theme6IndicatorColor.withValues(alpha: 0.5),
      ),
  ...
  timePickerTheme: TimePickerThemeData(
    ...
    hourMinuteColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return theme6IndicatorColor.withValues(
          alpha: 0.5,
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    enabledBorder: UnderlineInputBorder(
      borderSide: BorderSide(width: .5, color: theme6UnselectedColor),
    ),
    ...
    isDense: true,
    filled: false,
    hintStyle: TextStyle(color: theme6UnselectedColor, fontSize: 20),
    contentPadding: EdgeInsets.symmetric(vertical: 5.0, horizontal: 0.0),
    suffixStyle: TextStyle(color: theme6TitleBoxBcgColor),
    helperMaxLines: 1,
    helperStyle: TextStyle(color: theme6BaseTextColor, fontSize: 8.0),
    labelStyle: TextStyle(color: theme6UnselectedColor, fontSize: 20),
    alignLabelWithHint: true,
    prefixStyle: TextStyle(color: theme6UnselectedColor),
  ),
