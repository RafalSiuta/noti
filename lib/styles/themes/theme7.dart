...
const theme9SelDayColor = Color(0xFF658601);
const theme9FirstGradientColor = Color(0xFF151B1E);
...
final theme9 = ThemeData(
  ...
  colorScheme: const ColorScheme(
    ...
    primaryFixed: theme9CalendarMarkerColorOne,
    secondaryFixed: theme9CalendarMarkerColorTwo,
    surface: theme9TitleBoxBcgColor,
    error: Colors.redAccent,
    onPrimary: theme9SelDayColor,
  ...
  focusColor: theme9LastGradientColor,
  ...
  datePickerTheme: DatePickerThemeData(
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        theme9IndicatorColor.withOpacity(0.5),
      ),
  ...
  timePickerTheme: TimePickerThemeData(
    ...
    hourMinuteColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return theme9IndicatorColor.withValues(
          alpha: 0.5,
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        theme9IndicatorColor.withValues(alpha: 0.5),
      ),
      foregroundColor: WidgetStateProperty.all(theme9BaseTextColor),
      textStyle: WidgetStateProperty.all(
        GoogleFonts.chakraPetch(
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    enabledBorder: UnderlineInputBorder(
      borderSide: BorderSide(width: .5, color: theme9UnselectedColor),
    ),
    ...
    suffixStyle: TextStyle(color: theme9TitleBoxBcgColor),
    helperMaxLines: 1,
    ...
    labelStyle: TextStyle(color: theme9UnselectedColor, fontSize: 20),
    alignLabelWithHint: true,
    prefixStyle: TextStyle(color: theme9UnselectedColor),
  ),
