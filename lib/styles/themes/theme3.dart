...
const theme3SelDayColor = Color(0xFF2F3A49);
...
final theme3 = ThemeData(
    ...
    style: ButtonStyle(
      ...
      side: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.pressed) ||
          ...
          return const BorderSide(color: theme3IndicatorColor);
        }
        return const BorderSide(color: theme3BaseTextColor);
      }),
      splashFactory: NoSplash.splashFactory,
  ...
  datePickerTheme: DatePickerThemeData(
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        theme3IndicatorColor.withValues(alpha: 0.5),
      ),
  ...
  timePickerTheme: TimePickerThemeData(
    ...
    hourMinuteColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return theme3IndicatorColor.withValues(
          alpha: 0.5,
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    enabledBorder: UnderlineInputBorder(
      borderSide: BorderSide(width: .5, color: theme3UnselectedColor),
    ),
    ...
    isDense: true,
    filled: false,
    hintStyle: TextStyle(color: theme3UnselectedColor, fontSize: 20),
    contentPadding: EdgeInsets.symmetric(vertical: 5.0, horizontal: 0.0),
    suffixStyle: TextStyle(color: theme3TitleBoxBcgColor),
    helperMaxLines: 1,
    ...
    labelStyle: TextStyle(color: theme3UnselectedColor, fontSize: 20),
    alignLabelWithHint: true,
    prefixStyle: TextStyle(color: theme3UnselectedColor),
  ),
