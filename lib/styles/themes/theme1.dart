...
const theme1SelDayColor = Color(0xFFD0FBFD);
...
const theme1CalendarMarkerColorOne = Color(0xFF156660);
const theme1CalendarMarkerColorTwo = Color(0xFF1B8880);
...
final theme1 = ThemeData(
    ...
    style: ButtonStyle(
      ...
      side: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.pressed) ||
          ...
          return const BorderSide(color: theme1IndicatorColor);
        }
        return const BorderSide(color: theme1BaseTextColor);
      }),
      splashFactory: NoSplash.splashFactory,
  ...
  datePickerTheme: DatePickerThemeData(
    ...
    confirmButtonStyle: ButtonStyle(
      backgroundColor: WidgetStateProperty.all(
        theme1IndicatorColor.withValues(alpha: 0.5),
      ),
    ...
    todayBackgroundColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return theme1IndicatorColor.withValues(alpha: 0.5);
      }
  ...
  timePickerTheme: TimePickerThemeData(
    elevation: 0.2,
    dayPeriodColor: theme1IndicatorColor.withValues(alpha: 0.5),
    ...
    hourMinuteColor: WidgetStateColor.resolveWith((states) {
      if (states.contains(WidgetState.selected)) {
        return theme1IndicatorColor.withValues(
          alpha: 0.5,
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    enabledBorder: UnderlineInputBorder(
      borderSide: BorderSide(width: .5, color: theme1UnselectedColor),
    ),
    ...
    isDense: true,
    filled: false,
    hintStyle: TextStyle(color: theme1UnselectedColor, fontSize: 20),
    contentPadding: EdgeInsets.symmetric(vertical: 5.0, horizontal: 0.0),
    suffixStyle: TextStyle(color: theme1TitleBoxBcgColor),
    helperMaxLines: 1,
    helperStyle: TextStyle(color: theme1UnselectedColor, fontSize: 8.0),
    labelStyle: TextStyle(color: theme1UnselectedColor, fontSize: 20),
    alignLabelWithHint: true,
    prefixStyle: TextStyle(color: theme1UnselectedColor),
  ),
