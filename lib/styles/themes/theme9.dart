...
final theme9PickersBaseTextStyle = GoogleFonts.genos(
...
final theme9PickersTitleTextStyle = GoogleFonts.genos(
  textStyle: const TextStyle(
...
//headers:
//Large header:
final TextStyle theme9LargeHeaderTextStyle  = GoogleFonts.genos(
    textStyle: const TextStyle(
        color: theme9BaseTextColor,
        fontSize: 32,
...
//Subtitle header:
final TextStyle theme9SubtitleHeaderTextStyle = GoogleFonts.genos(
  textStyle: const TextStyle(
      fontSize: 18,
      color: theme9BaseTextColor,
      fontWeight: FontWeight.w300,
...
//title text style:
final TextStyle theme9CardTitleTextStyle = GoogleFonts.genos(
  textStyle: const TextStyle(
      fontSize: 12,
      color: theme9BaseTextColor,
      fontWeight: FontWeight.w300,
...
//content text:
final TextStyle theme9ContentTextStyle = GoogleFonts.genos(
  textStyle: const TextStyle(
      fontSize: 12,
      color: theme9BaseTextColor,
      fontWeight: FontWeight.w100,
...
final TextStyle theme9UnselectedTextStyle = GoogleFonts.genos(
  textStyle: const TextStyle(
      fontSize: 12,
...
//calendar text style:
//day text style:
final theme9CalendarDayWeekendTextStyle = GoogleFonts.genos(
    textStyle: const TextStyle(
        fontSize: 12,
...
final theme9CalendarNextMonthTextStyle = GoogleFonts.genos(
    textStyle: const TextStyle(
        fontSize: 12,
        color: theme9BaseTextColor,
        fontWeight: FontWeight.w100,
...
final theme9CalendarWeekendTextStyle = GoogleFonts.genos(
    textStyle: const TextStyle(
        fontSize: 12,
        color: theme9IndicatorColor,
        fontWeight: FontWeight.w100,
...
final theme9 = ThemeData(
    ...
    navigationRailTheme: NavigationRailThemeData(
      ...
      selectedLabelTextStyle: GoogleFonts.genos(
        textStyle: const TextStyle(
          color: theme9BaseTextColor, fontSize: 18, fontWeight: FontWeight.w300,
          backgroundColor: Colors.transparent,
        ),
      ),
      unselectedLabelTextStyle: GoogleFonts.genos(
        textStyle: const TextStyle(
          color: theme9UnselectedColor,
          fontSize: 17,
    ...
    datePickerTheme: DatePickerThemeData(
      ...
      confirmButtonStyle: ButtonStyle(
        ...
        textStyle: WidgetStateProperty.all(GoogleFonts.genos(
          textStyle: const TextStyle(
              color: theme9BaseTextColor,
              fontSize: 12,
              fontWeight: FontWeight.w100),
    ...
    tabBarTheme: TabBarTheme(
      ...
      unselectedLabelStyle: GoogleFonts.genos(
        textStyle: const TextStyle(
            fontSize: 12,
            color: theme9UnselectedColor,
            fontWeight: FontWeight.w100,
