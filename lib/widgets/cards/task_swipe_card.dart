...
class TaskSwipeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final marginTextBox = EdgeInsets.only(top:sideDifference, bottom: sideDifference, left: sideDifference, right: sideDifference / 2);


    final radiusContainer =
